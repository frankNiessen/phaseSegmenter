%% EDS_EBSD_Segmentator.m
% *************************************************************************
%                        EDS-EBSD Segmentator
%  Script for discrimination and segmentation of crystallographically similar
%  phases EBSD dataset by grain-median EDS thresholding
% *************************************************************************
...
scrPrnt('StartUp','EDS-EBSD Segmentator');                                 %StartUp Screen Print
%% Initialization
startup_mtex;                                                              %StartUp m-tex
% *** EBSD input parameters
